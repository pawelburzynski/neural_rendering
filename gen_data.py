...
path = '/home/pawelburzynski/Cambridge/PartII project/neural_rendering/main/Data/???/training/'
...
mw = camera.matrix_world
scene = bpy.context.scene
path = '/home/pawelburzynski/Cambridge/PartII project/neural_rendering/main/Data/???/eval/'
frame = 1
f = open(path+"data.txt", 'w', encoding='utf-8')
while frame <= 20:
...
mw = camera.matrix_world
scene = bpy.context.scene
path = '/home/pawelburzynski/Cambridge/PartII project/neural_rendering/main/Data/checkboard_plane/eval/'
frame = 1
while frame <= 20:
    offset = uniform(0,100)
    bpy.context.object.constraints['Follow Path'].offset = offset
