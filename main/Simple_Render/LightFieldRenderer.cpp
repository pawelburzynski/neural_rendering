...
void LightFieldRenderer::paint(QPainter *painter, QPaintEvent *event, int elapsed, const QSize &destSize)
{
...
void LightFieldRenderer::calculateArrayCameraViewTransform()
{
...
void LightFieldRenderer::calculateAllTransforms()
{
...
void LightFieldRenderer::readLfData(const char *lf_dir)
{
    int rMax = 0;
    int cMax = 0;
...
void LightFieldRenderer::updateViewSize(int newWidth, int newHeight)
{
...
void LightFieldRenderer::initOpenCL()
{
	try {
